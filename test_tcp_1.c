...
int main()
{
	...
	server_addr.sin_addr.s_addr = inet_addr("172.17.239.60");
	//向服务器发起连接
	...
	json_object_object_add(obj, "user", json_object_new_string("小hua"));
	json_object_object_add(obj, "password", json_object_new_string("22222"));
